...
urlpatterns = [
    ...
    url(r'^register_teacher/success/$', views.register_teacher_success, name = 'register_teacher_success'),
    ...
    url(r'^register_student/success/$', views.register_student_success, name = 'register_student_success'),
